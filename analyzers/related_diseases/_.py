...
class VaultQuery:
    ...
    def hub_query(self, parameters, db):
        ...
        For this variant and this disease, how many variant carriers have related diseases?
        (Note we currently interpret 'related' as 'exact', making this a duplicate of
        'variant_and_disease_count')
